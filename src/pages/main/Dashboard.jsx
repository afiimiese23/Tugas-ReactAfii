import { FaBed, FaSignInAlt, FaSignOutAlt, FaSearch, FaBell, FaRegHeart, FaRegCommentDots, FaRegEnvelope } from "react-icons/fa";
            ...
            <main className="p-8">
                <div className="mb-8">
                    <h1 className="text-2xl font-bold text-black">
                        Welcome Hotel, <span className="font-extrabold text-[#113D32]">StayZone!</span>
                    </h1>
                    <p className="text-black-400 text-sm mt-1">Don't Forget to Check your Activity</p>
                </div>
                ...
                <div className="grid lg:grid-cols-3 gap-8">
                    <div className="lg:col-span-2 bg-white p-8 shadow-sm border border-gray-50">
