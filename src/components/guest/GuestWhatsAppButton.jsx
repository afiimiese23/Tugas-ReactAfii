...
const WA_NUMBER = "6285157230509"; // format internasional tanpa +
...
export default function GuestWhatsAppButton() {
  return (
    ...
    >
      ...
      {/* Tooltip label */}
      <span className="
        absolute right-16 whitespace-nowrap rounded-lg bg-[#1a3c2e]
        px-3 py-1.5 text-xs font-medium text-white shadow-md
